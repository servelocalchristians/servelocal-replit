      ...
      <section className="bg-gradient-to-br from-primary to-blue-800 text-white py-8 sm:py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto">
            Inspired by ancient wisdom, building modern communities through
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-lg sm:text-xl text-gray-600">
              Our inspiration comes from one of history's greatest community
              rebuilding efforts
            </p>
          </div>
          ...
          <div className="prose prose-lg mx-auto text-gray-700">
            <p className="text-xl leading-relaxed mb-6">
              In the book of Nehemiah, we witness an extraordinary story of
              community collaboration. When Nehemiah received the call to
              rebuild Jerusalem's broken walls, he didn't work alone. Instead,
              he organized different tribes, families, and skilled workers—each
              contributing their unique abilities to restore their shared home.
            </p>
            ...
            <div className="bg-blue-50 border-l-4 border-primary p-6 my-8">
              <p className="italic text-lg">
                ...
                But the man who sounded the trumpet stayed with me... So we
                continued the work with half the men holding spears, from the
            ...
            <p className="text-lg leading-relaxed mb-6">
              What made their efforts successful wasn't just individual
              dedication, but their systematic approach to collaboration.
              Different groups took responsibility for different sections of the
              wall, yet they worked in unity toward a common goal. The
              goldsmiths worked alongside the perfume-makers, the merchants
              labored next to the temple servants, and families from various
              districts contributed according to their abilities.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              How the Nehemiah model translates to today's volunteer
              coordination
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 text-center">
                Like Nehemiah's systematic assignment of wall sections,
                ServeConnect organizes volunteer opportunities by location,
                skills, and timing to maximize impact.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 text-center">
                Jerusalem's walls protected everyone. Our volunteer efforts
                strengthen the entire community, creating lasting positive
                change for all.
              </p>
            </div>
          </div>
